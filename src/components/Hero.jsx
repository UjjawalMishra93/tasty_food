...
const Hero = ({ setSelectedCategory, onOpenAuth }) => {
    return (
        <section className="relative bg-[#FAFAFA] pt-40 pb-32 lg:pt-52 lg:pb-48">
            ...
            <div className="container mx-auto px-4 md:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div className="lg:w-1/2 space-y-8 text-center lg:text-left relative z-20">
                        <h1 className="text-4xl md:text-5xl lg:text-[4.5rem] font-extrabold text-dark-gray leading-[1.1]">
                            Welcome To <br />
                    ...
                    <div className="lg:w-1/2 relative perspective-1000 group mt-12 lg:mt-0">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] lg:w-[140%] h-[90%] lg:h-[140%] -z-10 opacity-60">
                            <img src="/hero-splash.png" alt="" className="w-full h-full object-contain opacity-20 scale-100 lg:scale-150 rotate-12" />
                        </div>

                        {/* Main Burger */}
                        <div className="relative z-10 animate-float drop-shadow-2xl hover:scale-105 transition-transform duration-700 ease-out px-4">
                            <img
                                src="/hero-burger.png"
                                alt="Tasty Burger"
                                className="w-full max-w-[300px] sm:max-w-[400px] lg:max-w-[550px] mx-auto"
                            />
                        </div>

                        {/* Floating Tomato */}
                        <div className="absolute top-0 left-4 lg:left-0 w-16 h-16 lg:w-24 lg:h-24 -translate-y-1/2 lg:-translate-x-1/4 z-0 animate-float" style={{ animationDelay: '0.5s', animationDuration: '4s' }}>
                            <img src="/floating-tomato.png" alt="" className="w-full object-contain drop-shadow-lg rotate-[-15deg]" />
                        </div>

                        {/* Floating Chili Right */}
                        <div className="absolute bottom-10 lg:bottom-20 right-4 lg:-right-10 w-20 h-20 lg:w-28 lg:h-28 z-20 animate-float" style={{ animationDelay: '1.5s', animationDuration: '3.5s' }}>
                            <img src="/floating-chili.png" alt="" className="w-full object-contain drop-shadow-xl rotate-[30deg]" />
                        </div>

                        {/* Floating Parsley Bottom Left */}
                        <div className="absolute -bottom-4 lg:-bottom-10 left-4 lg:left-10 w-16 h-16 lg:w-24 lg:h-24 z-20 animate-float" style={{ animationDelay: '2s', animationDuration: '5s' }}>
            ...
            <div className="absolute -bottom-16 w-full z-40 left-0">
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none rotate-180 pointer-events-none">
                <svg className="relative block w-full h-[30px] lg:h-[50px]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
